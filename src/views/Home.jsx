...
function SectionHeader({ title, linkTo, linkLabel = 'और देखें' }) {
    return (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
            ...
            {linkTo && (
                <Link href={linkTo} style={{ color: 'var(--teal)', fontWeight: 700, fontSize: '0.85rem' }}>
                    {linkLabel} →
                </Link>
            )}
        </div>
                        ...
                        {trending.length > 0 ? (
                            <div className="news-flash">
                                ...
                                <div className="news-flash__list">
                                    {trending.map((a, i) => (
                                        <Link key={a.id} href={articleHref(a)} className="news-flash__item">
                                            <span style={{
                                                fontSize: '0.95rem',
                                                fontWeight: 900,
                    ...
                    <div className="container">
                        ...
                        <div className="live-banner-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px', alignItems: 'center' }}>
                            <div style={{ color: 'white' }}>
                                ...
                                <Link href="/live" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                                    ▶ अभी देखें
                                </Link>
                            </div>
                ...
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '20px' }}>
                        {articles.filter(a => a.videoUrl).slice(0, 3).map(a => (
                            <Link key={a.id} href={articleHref(a)} style={{ textDecoration: 'none' }} className="news-card">
                ...
                <div className="container">
                    ...
                    <div className="epaper-banner-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '32px', alignItems: 'center' }}>
                        <div style={{ color: 'white' }}>
                            ...
                            <Link href="/epaper" className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                                📖 अभी पढ़ें
                            </Link>
                        </div>
