            ...
            <article>
                ...
                <div className="article-body">
                    ...
                    <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '16px', fontSize: '0.82rem', color: 'var(--gray-600)' }}>
                        <Link href="/" style={{ color: 'var(--teal)' }}>होम</Link>
                        <span>›</span>
                        <Link href={`/category/${article.category}`} style={{ color: 'var(--teal)' }}>{article.category}</Link>
                        <span>›</span>
                    ...
                    <div style={{ background: 'var(--gray-100)', padding: '40px 0', marginTop: '24px' }}>
                        <div className="container">
                            ...
                            <div className="news-grid news-grid-4">
                                {related.map(a => (
                                    <Link key={a.id} href={articleHref(a)} className="news-card" style={{ textDecoration: 'none' }}>
