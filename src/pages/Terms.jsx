...
export default function Terms() {
    ...
    return (
        <>
            <Helmet>
                <title>{isHi ? 'नियम और शर्तें | JG News Plus' : 'Terms & Conditions | JG News Plus'}</title>
            </Helmet>
            <div className="container section-gap" style={{ maxWidth: '780px' }}>
                ...
                <Section title={isHi ? '7. संपर्क' : '7. Contact'}>
                    {isHi
                        ? <span>इन नियमों से संबंधित किसी भी प्रश्न के लिए <Link to="/contact" style={{ color: 'var(--teal)', fontWeight: 700 }}>हमसे संपर्क करें</Link> या manoj@jgnews.live पर लिखें।</span>
                        : <span>For any questions regarding these terms, <Link to="/contact" style={{ color: 'var(--teal)', fontWeight: 700 }}>contact us</Link> or write to manoj@jgnews.live.</span>
                    }
                </Section>
                ...
                <div style={{ background: 'rgba(0,188,212,0.07)', borderRadius: 'var(--radius-md)', padding: '20px', marginTop: '8px', textAlign: 'center' }}>
                    ...
                    <Link to="/privacy" style={{ color: 'var(--teal)', fontWeight: 600, fontSize: '0.9rem' }}>{isHi ? 'गोपनीयता नीति' : 'Privacy Policy'} →</Link>
                </div>
            </div>
        </>
    );
