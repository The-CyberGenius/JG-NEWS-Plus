        ...
        <>
            ...
            <div className="container section-gap" style={{ maxWidth: '780px' }}>
                ...
                <Section title={isHi ? '8. संपर्क' : '8. Contact'}>
                    {isHi
                        ? <span>गोपनीयता से संबंधित किसी भी प्रश्न के लिए <Link href="/contact" style={{ color: 'var(--teal)', fontWeight: 700 }}>हमसे संपर्क करें</Link> या manoj@jgnews.live पर लिखें।</span>
                        : <span>For any privacy-related questions, <Link href="/contact" style={{ color: 'var(--teal)', fontWeight: 700 }}>contact us</Link> or write to manoj@jgnews.live.</span>
                    }
                </Section>
                ...
                <div style={{ background: 'rgba(0,188,212,0.07)', borderRadius: 'var(--radius-md)', padding: '20px', marginTop: '8px', textAlign: 'center' }}>
                    ...
                    <Link href="/terms" style={{ color: 'var(--teal)', fontWeight: 600, fontSize: '0.9rem' }}>{isHi ? 'नियम और शर्तें' : 'Terms & Conditions'} →</Link>
                </div>
            </div>
        </>
    );
